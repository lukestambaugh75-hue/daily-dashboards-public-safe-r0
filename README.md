...
Public-safe dashboard hub for shareable daily tracker views.

Live site:

https://lukestambaugh75-hue.github.io/public-safe-daily-dashboards-r0/
...
Detailed source dashboards stay in their private source repos or local-only
attachments. This hub is only the sanitized visual layer for links that need to
work for Luke or Devin.

## Included Public-Safe Views

- Washer Deal Tracker: sanitized decision and checkout-status view.
- Ford Raptor Tracker: sanitized market-summary view.
- Baby Gear Tracker: sanitized budget and category-summary view.
- PS5 and TV Tracker: links to the existing public dashboard.
